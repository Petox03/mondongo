            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 space-y-4">
                    ...
                    <form class="max-w-md mx-auto">
                        @component('components.input', ['name' => 'user', 'label' => 'Usuario'])
                        @endcomponent
                        @component('components.input', ['name' => 'score', 'type' => 'number', 'label' => 'Puntuación'])
                        @endcomponent
                        @component('components.input', ['name' => 'comment', 'label' => 'Comentarios'])
                        @endcomponent
                    </form>
                </div>
                <!-- Modal footer -->
                <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                    <button wire:click='addReview' data-modal-hide="default-modal" type="button"
